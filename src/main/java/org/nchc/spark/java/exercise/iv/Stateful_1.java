...
public class Stateful_1 {
    ...
    private static final Duration WINDOW_LENGTH = Durations.seconds(0);
    // Stats will be computed every slide interval time.
    private static final Duration SLIDE_INTERVAL = Durations.seconds(0);
    ...
    public static void main(String[] args) {
        ...
        JavaDStream<Long> contentSizeInWindow = accessLogDStream
                ...
                reduceByWindow((Function2<Long, Long, Long>) null, WINDOW_LENGTH, SLIDE_INTERVAL);
